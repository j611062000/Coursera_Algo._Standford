...
def strassen_algo(matrixA, matrixB):
    ...
    if n != len(matrixA[0]):
        ...
        print("debug:e{} f{} g{} h{}".format(e,f,g,h))
        print()
        print("matrixSubtraction(f,h):",matrixSubtraction(f,h))
        print("matrixSubtraction(a,b,+):",matrixSubtraction(a,b,"+"))
        print("matrixSubtraction(c,d,+):",matrixSubtraction(c,d,"+"))
        print("matrixSubtraction(g,e):",matrixSubtraction(g,e))
        print("matrixSubtraction(a,d,"+"):",matrixSubtraction(a,d,"+"))

        print(a, matrixSubtraction(f,h) )
        print(h, matrixSubtraction(a,b,"+") )
        print(e, matrixSubtraction(c,d,"+") )
        print(d, matrixSubtraction(g,e) )
        print( matrixSubtraction(a,d,"+"), matrixSubtraction(e,h,"+") )
        print( matrixSubtraction(b,d), matrixSubtraction(g,h,"+") )
        print( matrixSubtraction(a,c), matrixSubtraction(f,e,"+") )
        print("\n\n")
        """
        ...
        #print("p1{}, p2{}, p3{}, p4{}, p5{}, p6{}, p7{}".format(p1,p2,p3,p4,p5 ,p6 ,p7))
